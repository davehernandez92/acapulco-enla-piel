...
import restData from '@/json/restaurantes.json';
...
export default function Restaurante() {
    ...
    const restaurante = restData.find(h => h.id === restauranteId);
    if (!restaurante) {
        return <div>Restaurante not found</div>;
    }
        ...
        <div className='containerP lg:mx-10'>
            <div className='flex flex-col gap-5 mt-14 md:my-10 animate'>
                <div className='flex flex-col gap-8'>
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-[2.4rem] md:text-[3rem] lg:text-[5.5rem]'>{restaurante.name}</h1>
                        <p className=' font-light  '> restaurante</p>
                    </div>
                    <ul className='flex gap-1'>
                        ...
                        <li>
                            <p className="relative inline-block">
                                <span className="text-gray-800">{restaurante.name}</span>
                    ...
                    <div className='flex flex-col-reverse gap-8 lg:flex-row lg:mt-9 '>
                        ...
                        <Image
                            ...
                            width={600}
                            height={400}
                            alt={`Imagen del ${restaurante.name}`}
            ...
            >   <h2 className='text-[1.8rem] lg:text-[2.8rem]'> Galería </h2>
                <CarouselContent className='w-full'>
                    {restaurante.images.map((image, index) => (
            ...
            <div className='my-8 flex flex-col lg:flex-row md:gap-4 lg:my-[7rem] lg:gap-10'>
                ...
                <div className='mt-6'>
                    ...
                    <Link title='Video de youtube' target='blank' href={restaurante.youtube}>
                ...
                <div className=' flex flex-col gap-4 my-12 py-5 md:py-10 md:my-16 lg:mt-6 lg:py-0 lg:m-auto  '>
                    ...
                    <div className=' flex flex-col gap-3 md:text-center lg:mt-6  '>
                        <p>¿Quieres saber más sobre este restaurante?</p>
                        ...
                        <ul className='flex flex-col gap-5'>
                            <li >
                                <Link
                                    title='Telefono'
                                    target='blank'
                                    href={`tel:${restaurante.phoneNumber}`}
                            ...
                            {restaurante.whatsapp && (
                                <li className=''>
                                    <Link
                                        ...
                                        target='blank'
                                        href={`https://wa.me/+52${restaurante.whatsapp}`}
                                        className='flex gap-2 items-center text-[1.1rem] lg:text-[1.3rem] 
                                    lg:m-auto   
                                    w-fit
                                    transition-transform duration-300 transform hover:text-teal-800 focus:outline-none focus:ring focus:border-blue-300'
            ...
            <div className='flex justify-center py-9'>
                <Link className=' text-[18px] py-2 border-b-2 transition-transform duration-300 transform hover:text-teal-800 font-[500] focus:outline-none focus:ring focus:border-b-0 ' href={'/restaurantes'}>

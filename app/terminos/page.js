        ...
        <div className=" animate mt-24  mb-[15rem]  containerX flex flex-col lg:gap-4 md:w-full md:justify-center lg:w-[70%] lg:mx-auto">
            ...
            <div className='mt-5 flex flex-col gap-5 lg:mt-14'>
                ...
                <ol className='flex flex-col gap-5 md:gap-7'>
                    ...
                    <li>
                    <span className='font-semibold'>Modelo de Negocio: </span> Los usuarios que deseen publicitar sus negocios o servicios en nuestra página web deben pagar una cuota de membresía. Ofrecemos dos opciones de pago: una cuota mensual de 100 pesos sin plazo forzoso o una cuota anual de 600 pesos. <br/>Esta cuota es no reembolsable. Como marca y canal de YouTube, no tenemos ninguna afiliación ni somos empleados de los negocios o servicios publicitados en nuestra plataforma. Simplemente proporcionamos un servicio de anuncios.</li>
                    ...
                    <span className='font-semibold'>Privacidad de los Datos: </span>
                     Los datos recopilados por Acapulco en la Piel se utilizarán únicamente con el propósito de crear el anuncio del negocio o servicio y para mantener comunicación con el cliente. No compartiremos ni venderemos esta información a terceros en ningún caso.</li>

...
import negocioData from '@/json/negocios.json';
...
export default function Negocio() {
    ...
    const negocio = negocioData.find(h => h.id === negocioId);
    if (!negocio) {
        ...
        <div className='containerP lg:mx-10'>
            <div className='flex flex-col gap-5 mt-14 md:my-10 animate'>
                <div className='flex flex-col gap-8'>
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-[2.4rem] md:text-[3rem] lg:text-[5.5rem]'>{negocio.name}</h1>
                        <p className=' font-light  '> negocio</p>
                    </div>
                    <ul className='flex gap-1'>
                        ...
                        <li>
                            <p className="relative inline-block">
                                <span className="text-gray-800">{negocio.name}</span>
                    ...
                    <div className='flex flex-col-reverse gap-8 lg:flex-row lg:mt-9 '>
                        ...
                        <Image
                            src={negocio.images[0]}
                            width={600}
                            height={400}
                            alt={`Imagen del ${negocio.name}`}
            ...
            <div className='my-8 flex flex-col lg:flex-row md:gap-4 lg:my-[7rem] lg:gap-10'>
                ...
                <div className='mt-6'>
                    ...
                    <Link title='Video de youtube' target='blank' href={negocio.youtube}>
                ...
                <div className=' flex flex-col gap-4 my-12 py-5 md:py-10 md:my-16 lg:mt-6 lg:py-0 lg:m-auto  '>
                    ...
                    <div className=' flex flex-col gap-3 md:text-center lg:mt-6  '>
                        <p>¿Quieres saber más sobre este negocio?</p>
            ...
            <div className='flex justify-center py-9'>
                <Link className=' text-[18px] py-2 border-b-2 transition-transform duration-300 transform hover:text-teal-800 font-[500] focus:outline-none focus:ring focus:border-b-0 ' href={'/negocios'}>
                    Ver mas negocios
                </Link>
            </div>
